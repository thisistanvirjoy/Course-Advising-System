...
if (isset($_POST['assign_advisor'])) {
    ...
    $checkExisting->bind_param("i", $student_id);
    ...
    if ($row['advisor_id'] == NULL) {
        ...
        $assignQuery->bind_param("ii", $teacher_id, $student_id);
...
<header class="bg-white shadow">
    ...
    <?php endif; ?>"bg-red-200 text-red-800 px-4 py-2 rounded mb-4">
            <?php echo $error_message; ?>
        </div>
    <?php endif; ?>

    <form action="assign_advisors.php" method="POST" class="mb-6">
